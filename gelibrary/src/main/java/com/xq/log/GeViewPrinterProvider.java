 ...
 * author：Christiano
 * gitee:
 * time：2021/06/01 18:35
 */
public class GeViewPrinterProvider {
    ...
    public GeViewPrinterProvider(FrameLayout rootView, RecyclerView recyclerView) {
    ...
    public void showFloatingView() {
        ...
        params.bottomMargin = com.xq.log.HiDisplayUtil.dp2px(100, rootView.getResources());
    ...
    public void showLogView() {
        ...
        FrameLayout.LayoutParams params =
                new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, com.xq.log.HiDisplayUtil.dp2px(160, rootView.getResources()));
